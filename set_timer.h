...
#define Dis_OutClk "\x01outclk0" // 关闭对应定时器的时钟输出功能，默认是关闭的
#define En_OutClk "\x01outclk1"   // 打开对应定时器的时钟输出功能
// T0CLKO=P35, T1CLKO=P34, T2CLKO=P11, T3CLKO=P05, T4CLKO=P07, T11CLKO=P21

#define Time_Mode "ct0" //计时模式，时钟源为定时器
#define Cnt_Mode "ct1" //外部脉冲计数模式，时钟源为外部脉冲输入
...
//用于获取定时器的计数数值，每次获取后自动清零，然后重新开始获取
